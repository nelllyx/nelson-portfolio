const Footer = () => (
  <footer className="w-full mt-16" style={{ background: 'var(--primary-bg)' }}>
    <div className="max-w-5xl mx-auto px-4 py-8 flex flex-col md:flex-row items-center justify-between">
      <div className="text-sm text-gray-400 mb-4 md:mb-0">&copy; {new Date().getFullYear()} Nelson Akewe. All rights reserved.</div>
      <div className="flex space-x-4">
        <a href="https://github.com/nelllyx" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition-colors" aria-label="GitHub">
        ...
        <a href="https://www.linkedin.com/in/nelson-akewe-785b14236/" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition-colors" aria-label="LinkedIn">
